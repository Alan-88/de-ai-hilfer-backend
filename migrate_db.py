...
CLOUD_POSTGRES_URL = "postgresql://neondb_owner:npg_RNtUcf8Td0vb@ep-fragrant-bar-a1g0ncrm-pooler.ap-southeast-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require" # 【请确保这里是你真实的连接 URL】
# -------------------------------------------------------------
...
def migrate_data():
    ...
    print("1/4: 正在连接到本地 SQLite 数据库并读取所有数据...")
    conn = sqlite3.connect(LOCAL_SQLITE_DB_PATH)
    conn.row_factory = sqlite3.Row # 使用字典行工厂，方便按列名访问
    cursor = conn.cursor()
